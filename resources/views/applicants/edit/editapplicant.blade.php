                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <small class="text-muted">{{ $employee->employment->position }}</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="position" name="position" value="{{ $employee->employment->position }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
