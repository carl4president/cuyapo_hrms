...
<x-layouts.add-emp-modal modal_title='Add Your Details' :route="route('all/employee/save')" :routeUrl="route('hr/get/information/emppos')" :$departments :$userList :$employee :positions="null">
    <!-- Employment Details -->
    <div class="col-12">
