    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-12">
                    <h3 class="page-title">Rejected Candidates</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item">Jobs</li>
                        <li class="breadcrumb-item active">Rejected Candidates</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped custom-table mb-0 datatable">
                        ...
                        <tbody>
                            ...
                            @php
                            $status = $app->employment->status ?? 'Rejected';
                            if (!in_array($status, ['Rejected'])) continue;
                            @endphp
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown action-label">
                                        <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false" id="status_label{{ $app->app_id }}">
                                            @php
                                            $status = $app->employment->status ?? 'Rejected'; // Default to 'Rejected'
                                            $statusColors = [
                                            'New' => 'text-info',
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right job_status">
                                            ...
                                            <a class="dropdown-item status-option" data-id="{{ $app->app_id }}" data-status="New">
                                                <i class="fa fa-dot-circle-o text-info"></i> Move Back to Applicant
                                            </a>
                                        </div>
                                    </div>
                                </td>
...
<script>
    $(document).ready(function() {
        ...
        var defaultMessages = {
            "New": "We are pleased to inform you that your application is under reconsideration."
        };
